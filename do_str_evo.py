from simulator import strategies_evolution
import sys
...
def main():
    ...
    str_changes = strategies_evolution(algorithm, game(1, citizens, f=multiplier),
                                        policy, 20, iterations=rounds, show=True)

    file_name = "str_evo_" + sys.argv[1] + "_" + sys.argv[2] + "_" + sys.argv[3] + "_" + sys.argv[4] + \
