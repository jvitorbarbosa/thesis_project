...
def main():
    ...
    strategies = strategies_learned(algorithm, game(1, citizens, f=multiplier),
                                    policy, 20, iterations=rounds, show=True)

    file_name = "strategies_" + sys.argv[1] + "_" + sys.argv[2] + "_" + sys.argv[3] + "_" + sys.argv[4] + \
